  ...
  const addFiles = (incoming) => {
    ...
    const valid = arr.filter((f) => {
      if (!ALLOWED_TYPES.includes(f.type)) {
        err = t("contactPage.fileTypeError");
        return false;
      }
      if (f.size > MAX_FILE_SIZE) {
        err = t("contactPage.fileSizeError");
        return false;
      }
      return true;
    });
          ...
          <div className="contact-page__grid">
            ...
            <div className="contact-page__form-side">
              {status === "success" ? (
                ...
                >
                  ...
                  {/* Phone */}
                  <div
                    className={`cp-field${errors.phone ? " has-error" : ""}`}
                  >
                    ...
                    />
                    {errors.phone && (
                      <span className="cp-field__error">{errors.phone}</span>
                    )}
                  </div>

                  {/* Service */}
                  <div
                    className={`cp-field${errors.service ? " has-error" : ""}`}
                  >
                    <label htmlFor="cp-service">
                    ...
                    {errors.service && (
                      <span className="cp-field__error">{errors.service}</span>
                    )}
                  </div>
                  ...
                  <div className="cp-field">
                    ...
                    {errors.files && (
                      <span className="cp-field__error">{errors.files}</span>
                    )}
                      ...
                      <ul className="cp-files">
                        {files.map((file, i) => (
                          <li key={i} className="cp-files__item">
                            ...
                            <span className="cp-files__size">
                              {formatSize(file.size)}
                            </span>
                            <button
                              type="button"
                              className="cp-files__remove"
            ...
            <div className="contact-page__info-side">
                ...
                <ul className="contact-page__info-list">
                  ...
                  <li>
                    ...
                    <div>
                      ...
                      <a href="mailto:bestperevodi1@mail.ru">
                        bestperevodi1@mail.ru
                      </a>
                    </div>
                  </li>
                  <li>
              ...
              <div className="contact-page__office-photo">
                <Image
                  src="/office.jpg"
                  alt={t("contactPage.officePhotoAlt")}
                  fill
