    ...
    <main className="services-page">
      ...
      <section className="services-page__hero">
        <div className="container">
          <span className="section-header__eyebrow">{t('servicesPage.eyebrow')}</span>
          <h1 className="services-page__hero-title">{t('servicesPage.title')}</h1>
          <p className="services-page__hero-subtitle">{t('servicesPage.subtitle')}</p>
        </div>
      </section>
      ...
      <section className="services-page__list section">
        <div className="container">
          {SERVICES.map((service, index) => (
            <div
              key={service.key}
              className={`services-page__item${index % 2 !== 0 ? ' services-page__item--reverse' : ''}`}
            >
              {/* Visual side */}
              <div className="services-page__visual">
                <div className="services-page__visual-inner">
                  <div className="services-page__icon">
                    {service.icon}
                  </div>
                  <div className="services-page__meta">
                    <div className="services-page__meta-item">
                      <span className="services-page__meta-label">{t('servicesPage.time')}</span>
                      <span className="services-page__meta-value">
                        {t(`servicesPage.items.${service.key}.time`)}
                      </span>
                    </div>
                    <div className="services-page__meta-divider" />
                    <div className="services-page__meta-item">
                      <span className="services-page__meta-label">{t('servicesPage.price')}</span>
                      <span className="services-page__meta-value">
                        {t(`servicesPage.items.${service.key}.price`)}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="services-page__content">
                <span className="services-page__number">0{index + 1}</span>
                <h2 className="services-page__item-title">
                  {t(`services.items.${service.key}.title`)}
                </h2>
                <p className="services-page__item-desc">
