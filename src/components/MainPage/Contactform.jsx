          ...
          <div className="contact-form__form-wrap">
            {status === "success" ? (
              ...
              >
                {/* Name */}
                <div
                  className={`contact-form__field${errors.name ? " has-error" : ""}`}
                >
                ...
                {/* Phone */}
                <div
                  className={`contact-form__field${errors.phone ? " has-error" : ""}`}
                >
                ...
                {/* Service */}
                <div
                  className={`contact-form__field${errors.service ? " has-error" : ""}`}
                >
